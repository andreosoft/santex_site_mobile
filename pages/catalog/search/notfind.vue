<template>
    <v-container class="mb-10 s-fav-empty">
        <v-divider class="mb-8" />
        <common-beadcrumbs class="mb-4" :value="breadcrumbsData" />
        <h1>Поиск</h1>
        <div class="mb-10">
            <p><b>Вы искали:</b> <span class="underlined">название искомово</span> , найдено 0 шт.</p>
        </div>
            ...
            <div style="width: 724px;">
                <v-text-field single-line outlined dense label="Я хочу найти">
                    <template v-slot:append>
                        <img @click="$router.push({ path: '/catalog/search', query: { q: this.search } })" src="/icons/Search.svg" />
                    </template>
                </v-text-field>
            </div>
        </div>
