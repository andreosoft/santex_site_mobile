<template>
    <v-container class="mb-14">
            ...
            <v-col cols="6">
                ...
                <div class="my-8">
                    <div class="d-flex justify-space-between align-center">
                        <div>
                            <span>
                                <v-btn style="width: 200px;" class="s-btn-cart s-btn-text" dark>перейти к товарам
                                </v-btn>
                            </span>
                        </div>
                        <div>
        ...
        <div class="mb-14">
            <h2 class="mb-4">Товары из коллекции</h2>
            <div class="d-flex mb-4">
                <v-btn dark class="s-btn-text mr-4">Все</v-btn>
                <v-btn class="s-btn-text mr-4">Плитка настенная</v-btn>
                <v-btn class="s-btn-text mr-4">Плитка</v-btn>
                <v-btn class="s-btn-text mr-4">Декор</v-btn>
            </div>
            <div>
                <v-row class="s-row">
...
export default {
    ...
    async asyncData(params) {
        ...
        const data = {
            ...
            image: ["/img/catalog/collection/1.png", "/img/catalog/collection/2.png", "/img/catalog/collection/3.png", "/img/catalog/collection/4.png"],
