    ...
    <v-container class="mb-10 s-static-main">
        ...
        <div id="order" class="d-flex justify-space-between align-center">
            ...
            <div class="d-none d-sm-block pb-5">
                <v-btn 
                    v-show="DataCart.length !== 0 || send == true" 
                    outlined 
                    class="mb-5 pt-2 pb-2 clearBtn" 
                    @click="toCatalog"
                    >
                ...
                <div v-if="send == true">
                  ...
                  <div v-for="(el, i) in cartData" :key="i" class="align-center">
                    ...
                    <div class="mb-8 d-flex flex-column align-center">
                        <div class="w-100">
                            ...
                            <div class="mb-4 w-100">
                                <v-btn-toggle 
                                class="orderToggle w-100 d-flex align-center justify-space-between" 
                                v-model="toggleData"
                                mandatory
                                >
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            <v-btn-toggle 
                            class="mr-8 orderToggle d-flex align-center justify-content-between w-100" 
                            v-model="toggleData2"
                            mandatory
                            >
